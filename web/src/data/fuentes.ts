...
export const fuentes = {
  ...
  F012: {
    id: 'F012',
    titulo: 'Buscador de centros educativos: ficha del IES Diego Velázquez (otras series de «Resultados académicos» y «Datos estadísticos»)',
    autor: 'Comunidad de Madrid, Consejería de Educación',
    url: 'https://gestiona.comunidad.madrid/wpad_pub/run/j/MostrarFichaCentro.icm?cdCentro=28037089',
    fecha: 'consulta en línea',
    consultada: '24/09/2026',
    nota: 'Las series se eligen con las opciones de cada gráfica: «Bachillerato» en titulación; «Nº de alumnos presentados» y «% de alumnos aptos» en la PAU; «Bachillerato» en admisión.',
  },
  F013: {
    id: 'F013',
    titulo: 'Estadística de la Enseñanza: tasas de idoneidad en Educación Obligatoria por edad y sexo',
    autor: 'Comunidad de Madrid, D. G. de Bilingüismo y Calidad de la Enseñanza',
    url: 'https://gestiona.comunidad.madrid/este_web/Report/ReportTemplate?ReportName=27_TasasIdoneidad_EducObligatoriaEdadSexo&ReportDescription=Tasas%20de%20idoneidad&Width=100&Height=650',
    fecha: 'datos provisionales hasta 2023-24',
    consultada: '24/09/2026',
    nota: 'Se elige el área (Comunidad, D.A.T. Oeste o municipio de Torrelodones) y el curso. El municipio incluye todos sus centros, no solo el IES.',
  },
  RD534: {
    id: 'RD 534/2024',
